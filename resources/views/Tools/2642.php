            ...
            <div class="cwrap-item2" style="text-align: center">
                ...
                <table style="width: 100%; border: solid 1px #000; border-collapse: collapse;">
                    <tr class="tabel-head">
                        ...
                        <td class="vlr" style="background: #f7fac3;">I квартал</td>
                        <td class="vlr">апрель</td>
                        <td class="vlr">май</td>
                        <td class="vlr">июнь</td>
                        <td class="vlr" style="background: #f7fac3;">II квартал</td>
                        <td class="vlr" style="background: #5f8fff;">I полугодие</td>
                        <td class="vlr">июль</td>
                        <td class="vlr">август</td>
                        <td class="vlr">сентябрь</td>
                        <td class="vlr" style="background: #f7fac3;">III квартал</td>
                        <td class="vlr">октябрь</td>
                        <td class="vlr">ноябрь</td>
                        <td class="vlr">декабрь</td>
                        <td class="vlr" style="background: #f7fac3;">IV квартал</td>
                        <td class="vlr" style="background: #5f8fff;">II полугодие</td>
                        <td class="vlr" style="background: #ff6332;">год</td>
                    </tr>
                    <tr>
                        ...
                        <td class="rowTabel">31</td>
                        <td class="rowTabel" style="background: #f7fac3;">90</td>
                        <td class="rowTabel">30</td>
                        <td class="rowTabel">31</td>
                        <td class="rowTabel">30</td>
                        <td class="rowTabel" style="background: #f7fac3;">91</td>
                        <td class="rowTabel" style="background: #5f8fff;">181</td>
                        <td class="rowTabel">31</td>
                        <td class="rowTabel">31</td>
                        <td class="rowTabel">30</td>
                        <td class="rowTabel" style="background: #f7fac3;">92</td>
                        <td class="rowTabel">31</td>
                        <td class="rowTabel">30</td>
                        <td class="rowTabel">31</td>
                        <td class="rowTabel" style="background: #f7fac3;">92</td>
                        <td class="rowTabel" style="background: #5f8fff;">184</td>
                        <td class="rowTabel" style="background: #ff6332;">365</td>
                    </tr>
                    <tr>
                        ...
                        <td class="rowTabel" style="background: #ff6332;">247</td>
                    </tr>
                    <tr>
                        ...
                        <td class="rowTabel" style="background: #ff6332;">118</td>
                    </tr>
                    <tr>
                        ...
                        <td class="rowTabel fs-14" style="background: #ff6332;">1972</td>
                    </tr>
                    <tr>
                        ...
                        <td class="rowTabel fs-10" style="background: #ff6332;">1774.4</td>
                    </tr>
                    <tr>
                        ...
                        <td class="rowTabel fs-10" style="background: #ff6332;">1181.6</td>
                    </tr>
                </table>
